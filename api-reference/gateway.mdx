...
```bash
# Get a swap quote
curl -u YOUR_USERNAME:YOUR_PASSWORD -X POST http://localhost:8000/gateway/swaps/quote \
...
# Execute the swap
curl -u YOUR_USERNAME:YOUR_PASSWORD -X POST http://localhost:8000/gateway/swaps/execute \
  -H "Content-Type: application/json" \
  -d '{
    "chain": "solana",
    "network": "mainnet",
...
curl -u YOUR_USERNAME:YOUR_PASSWORD -X POST http://localhost:8000/gateway/clmm/pools \
  -H "Content-Type: application/json" \
  -d '{
    "chain": "solana",
    "network": "mainnet",
...
**API:**
```bash
curl -u YOUR_USERNAME:YOUR_PASSWORD -X POST http://localhost:8000/gateway/wallets/add \
  -H "Content-Type: application/json" \
  -d '{
    "chain": "solana",
