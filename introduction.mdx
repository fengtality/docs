...
[Condor](/condor/overview) (Telegram) and [Condor Dashboard](/dashboard/overview) (web) are reference clients that demonstrate how to build applications using the API.
