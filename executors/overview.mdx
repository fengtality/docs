...
```bash
# List executors
curl -u YOUR_USERNAME:YOUR_PASSWORD http://localhost:8000/executors

# Filter by agent
curl -u YOUR_USERNAME:YOUR_PASSWORD "http://localhost:8000/executors?controller_id=my-agent"

# Stop executor
curl -u YOUR_USERNAME:YOUR_PASSWORD -X DELETE http://localhost:8000/executors/{id}
```
