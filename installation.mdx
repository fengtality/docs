...
> **Note:** After a successful start, **admins** should receive **"Condor is online and ready."** in Telegram. If not, see [Installing Condor — Common failure modes](/getting-started/installing#common-failure-modes).
