...
> **Note:** After a successful start, **admins** should receive **"Condor is online and ready."** in Telegram. If not, see [Installing Condor — Troubleshooting](/getting-started/installing#troubleshooting).
