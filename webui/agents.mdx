...
Every page shares the same chrome. Left to right: the seven page tabs (**Agents · Portfolio · Trade · DEX · Bots · Executors · Routines**), then the **server selector** (which Hummingbot API instance you are driving — the green dot is its health), the **quote currency** the UI prices things in, the **notification bell**, the **Report an issue** button, the **Settings** gear, and an **eye** that hides balances for screen-sharing.
