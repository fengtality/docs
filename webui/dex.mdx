...
The **DEX** page is pool discovery: the pools Condor can trade through [Gateway](/other-features/gateway), ranked and filterable. Open a pool to chart it, swap in it, and provide liquidity to it.
...
- [LP management](/other-features/lp) — positions, fees, and closing
- [Gateway](/other-features/gateway) — the DEX middleware underneath, and its [Settings tab](/webui/settings#gateway)
