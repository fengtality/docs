...
<Note>
The Market tab has been merged into Trade for a streamlined experience.
</Note>

### Bots

Deploy and manage bot instances:
- **Status**: Realized P&L, unrealized P&L, total P&L, volume traded, uptime
- **Config Viewer**: View controller configuration inline
- **Logs**: Full logs with error filtering
...
- **Schedule**: Set up recurring routine execution
- **Reports**: View HTML reports with interactive Plotly charts
