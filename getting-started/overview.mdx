...
<Steps>
  ...
  <Step title="Telegram Interface">
    Control your trading infrastructure via mobile-friendly commands — or skip it entirely with [Local mode](/getting-started/installing#choosing-telegram-or-local-mode) and drive Condor from the browser
  </Step>
...
- A **Telegram** account and bot token — unless you install in [Local mode](/getting-started/installing#choosing-telegram-or-local-mode), which needs neither
